...
This is a sample template for lambda-test - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name lambda-test --tail
```
...
```bash
aws cloudformation delete-stack --stack-name lambda-test
```
